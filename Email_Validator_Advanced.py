...
def get_arguments():
	...
	parser.add_argument('-e','--email',dest="email", help="[-] Specify Email Address Ex: killer@yahoo.com")
	parser.add_argument('-w','--wordlist',dest="wordlist", help="[-]Use a Wordlist to bruteForce Multiple Emails")
